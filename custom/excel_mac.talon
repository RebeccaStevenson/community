...
# format general: key(cmd-~)
# format currency: key(cmd-$)
# format (percent | percentage): key(cmd-%)
# format (decimal | number): key(cmd-!)
# format exponential: key(cmd-^)
# format date: key(cmd-#)
# format time: key(cmd-@)
...
# array select: key(cmd-/)

column hide: key(cmd-0)
# column unhide: key(cmd-shift-0)
